...
function sanitizer(html) {
    return insane(html, {
        ...
        allowedAttributes: Object.assign(Object.assign({}, ALLOWED_TAGS.reduce((res, tag) => {
            ...
            ], table: ["width", ...GENERIC_ALLOWED_ATTRIBUTES], td: ["align", "width", ...GENERIC_ALLOWED_ATTRIBUTES], th: ["align", "width", ...GENERIC_ALLOWED_ATTRIBUTES], a: ["href", "target", ...GENERIC_ALLOWED_ATTRIBUTES], ol: ["start", ...GENERIC_ALLOWED_ATTRIBUTES], ul: ["start", ...GENERIC_ALLOWED_ATTRIBUTES] }),
    });
}
